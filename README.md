...
사용자는 Web·CLI·REST API·MCP에서 문서를 검색하고, 근거와 함께 답변 받을 수 있습니다.
...
Tibero Doc의 자체 개발 소스코드는 [Apache License 2.0](LICENSE)으로 배포됩니다.
누구나 라이선스 조건에 따라 코드를 사용·수정·배포할 수 있으며, 외부 라이브러리와 OpenSQL 등 제3자 구성요소에는 각각의 라이선스가 적용됩니다.
